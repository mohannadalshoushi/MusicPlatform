class Fretboard {
  ...
  getFretSelects() {
    ...
    if (!fret_selects) {
      fret_selects =
        "section1,section2,section3,tuningStr1,tuningStr2,tuningStr3,tuningStr4,tuningStr5,tuningStr6,inline_buttons";
    }
  ...
  showANote() {
    ...
    if (this.currentShuffledNotes.length === 0) {
      this.currentShuffledNotes = this.shuffleArray(
        this.currentShuffledNotesCopy.slice(0),
      );
    }
